...
Flashing the application image depends on your environment (MCU-Link,
LinkServer, pyOCD, etc.).

This project also expects the Doom game data in external flash (XIP), mapped
at `0x80000000` on the FRDM-MCXN947.

The recommended default is the pre-populated full external-flash image
