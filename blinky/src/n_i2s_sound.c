...
sound_module_t sound_i2s_module = {
    sound_sdl_devices,       arrlen(sound_sdl_devices), N_I2S_InitSound,
    N_I2S_ShutdownSound,     N_I2S_GetSfxLumpNum,       N_I2S_UpdateSound,
    N_I2S_UpdateSoundParams, N_I2S_StartSound,          N_I2S_StopSound,
    N_I2S_SoundIsPlaying,    N_I2S_PrecacheSounds,
};
