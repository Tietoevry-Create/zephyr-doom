...
#define QSPI_SCK_PIN NRF_GPIO_PIN_MAP(0, 17)
#define QSPI_CSN_PIN NRF_GPIO_PIN_MAP(0, 18)
#define QSPI_IO0_PIN NRF_GPIO_PIN_MAP(0, 13)
#define QSPI_IO1_PIN NRF_GPIO_PIN_MAP(0, 14)
#define QSPI_IO2_PIN NRF_GPIO_PIN_MAP(0, 15)
#define QSPI_IO3_PIN NRF_GPIO_PIN_MAP(0, 16)
