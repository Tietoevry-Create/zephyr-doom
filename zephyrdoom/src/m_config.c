...
#define CONFIG_VARIABLE_GENERIC(name, type) {#name, {NULL}, type, false}
/*
 * NRFD-TODO
 * Translate key.
...
static default_t doom_defaults_list[] =
    {
         ...
         *
         * //!
         * // Keyboard key to "use" an object, e.g. a door or switch.
         * //
         ...
         *
         * //!
         * // Joystick virtual button to "use" an object, e.g. a door or switch.
         * //
...
static default_t extra_defaults_list[] =
    {
         ...
         *
         * //!
         * // Mouse button to "use" an object, e.g. a door or switch.
         * //
         ...
         * // the "use" key to use an object in-game, e.g. a door or switch.
         * //
 ...
 *  1. KEY_PAUSE is wrong - it's in the KEY_NUMLOCK spot. This shouldn't
 *     matter in terms of Vanilla compatibility because neither of
 *     those were valid for key bindings.
 *  2. There is no proper scan code for PrintScreen (on DOS machines it
...
static void SaveDefaultCollection(default_collection_t *collection, const char *filename)
{
     ...
     *         // the possibility of screwing up the user's configuration
     *         // file.
...
static void SetVariable(default_t *def, char *value)
{
    ...
    case DEFAULT_KEY:
        ...
        /*
         * Translate scancodes read from configuration
