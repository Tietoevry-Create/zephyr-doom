...
void R_AddLine(seg_t *line)
{
    ...
    /*
     * TODO
     * Quickly reject orthogonal back sides.
     */
     ...
     *
     * TODO
     * Make constant out of 2*clipangle (FIELDOFVIEW).
     */
    span = angle1 - angle2;
     ...
     */
    if (backsector->ceilingpic == frontsector->ceilingpic && backsector->floorpic == frontsector->floorpic && backsector->lightlevel == frontsector->lightlevel && SegSideDef(curline)->midtexture == 0)
    {
        return;
    }
