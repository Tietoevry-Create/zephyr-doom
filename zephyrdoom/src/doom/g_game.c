...
const boolean singledemo = false;
...
boolean gamekeydown(int key)
{
    /*
     * NRFD-TODO
     * Fix gamekeydown implementation.
     */
    int word_idx = key >> 5;
...
void G_BuildTiccmd(ticcmd_t *cmd, int maketic)
{
    ...
    /*
     * NRFD-TODO
     * Fix mouse implementation and lots of stuff below.
     */
    ...
    if (gamekeydown(key_strafeleft) || joybuttons[joybstrafeleft] || joystrafemove < 0
    ...
    if (gamekeydown(key_straferight) || joybuttons[joybstraferight] || joystrafemove > 0
...
void G_BeginRecording(void)
{
     ...
     *
     * // If not recording a longtics demo, record in low resolution
