...
/*
 * NRFD-TODO
 * Check values for all supported games.
 */
...
{
    /*
     * Block origin (allways UL), which has already accounted
 ...
 * but any columns with multiple patches will have new column_ts generated.
 */
/*
 * // TODO
...
void R_GenerateComposite_N(int num, texture_t *texture, char *patch_names)
{
    ...
    for (int i = 0; i < texture_size; i++)
    {
        /*
         * NRFD-TODO
         * Verify that textures don't have 251 in them.
         * PINK, use as transparent is masked textures.
         */
        generate_buffer[i] = 251;
    }
    ...
    for (i = 0; i < patchcount; i++)
    {
        ...
        /* Having some trouble with reliable reading of this data from QSPI */
...
void R_InitTextures(void)
{
    ...
    /*
     * NRFD-TODO
     * Copy names to texture_names, use in name lookup functions,
     * and possibly release names after level is loaded.
     */
    ...
    /*
     * // NRFD-NOTE
     * // Do second pass after allocating texture patches.
...
void R_InitFlats(void)
{
    ...
    /*
     * NRFD-TODO
     * Assert that numflats < 65k
     */
    printf("R_InitFlats: firstflat = %d, numflats = %d\n", firstflat, numflats);

    /*
     * NRFD-TODO
     * flattranslation could be bytes if we used offset from firstflat.
     * Create translation table for global animation.
     */
...
int R_CheckTextureNumForName(const char *name)
{
    ...
    /*
     * NRFD-NOTE
     * Slower but requires less memory. Potential for optimization.
     */
...
void R_PrecacheLevel(void)
{
     ...
     * // a wall texture, with an episode dependend name.
