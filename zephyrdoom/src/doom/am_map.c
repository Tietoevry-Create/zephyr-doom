...
/*
 * Should be called at the start of every level right now.
...
/* Classic Bresenham with whatever optimizations needed for speed. */
...
void AM_drawGrid(int color)
{
    ...
    /* Figure out start of horizontal grid lines */
    start = m_y;
...
void AM_drawLineCharacter(const mline_t *lineguy, int lineguylines,
