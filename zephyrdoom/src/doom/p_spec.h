...
/* NRFD-NOTE: int changed to char/short in struct below. */
...
/* How many different types of animations. */
...
result_e
T_MovePlane(sector_t *sector, fixed_t speed, fixed_t dest, boolean crush,
