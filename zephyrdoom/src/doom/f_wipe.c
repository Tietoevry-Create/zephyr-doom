...
/*
 * // TODO
 * // Heap overflow at startup with this uncommented.
 * #define INCLUDE_WIPE
 */
...
void wipe_shittyColMajorXform(dpixel_t *array, int width, int height)
{
    ...
    dest = (dpixel_t *)I_VideoBackBuffer;
    /* (dpixel_t*) Z_Malloc(width*height*sizeof(*dest), PU_STATIC, 0); */
...
int wipe_ScreenWipe(int wipeno, int x, int y, int width, int height, int ticks)
{
    ...
    if (!go)
    {
        ...
        /*
         * // DEBUG
         * wipe_scr = (pixel_t *) Z_Malloc(width*height, PU_STATIC, 0);
         */
    ...
    /*
     * // DEBUG
     * V_DrawBlock(x, y, 0, width, height, wipe_scr);
     */
