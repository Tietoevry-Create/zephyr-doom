...
typedef struct __attribute__((packed))
{
     ...
     * NRFD-NOTE: Changed from int to uint8_t
     */
    uint8_t validcount;
...
typedef struct __attribute__((packed))
{
     ...
     *
     * NRFD-TODO:
     * Support more than 256 textures.
     */
    byte toptexture;
    byte bottomtexture;
    byte midtexture;
 ...
 *  a three dimensional object and may have multiple rotations pre drawn.
...
typedef struct __attribute__((packed))
{
     ...
     *
     * NRFD-NOTE
     * Optimized for memory, used to be - byte flip[8];
     */
    byte flip;
} spriteframe_t;
