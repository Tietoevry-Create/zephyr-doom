...
typedef struct __attribute__((packed)) mobj_s
{
    ...
    int8_t               movedir;        // 0-7                       // NRFD-NOTE: was int
    int8_t               movecount;      // when 0, select a new dir  // NRFD-NOTE: was int
    ...
    int8_t              reactiontime;     // NRFD-NOTE: was int

    // If >0, the target will be chased
    // no matter what (even if shot)
    int8_t              threshold;  // NRFD-NOTE: was int
